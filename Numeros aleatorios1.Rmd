...
*Un examen tiene 10 preguntas y cada una tiene 3 opciones como respuesta, siendo solo una de ellas la correcta.Si un estudiante contesta al azar, la probabilidad de que tenga 5 preguntas o mas correctas es de 0.2334. ¿Cuantas veces ocurrira este evento en 7 observaciones?*

```{r}
x = binomial(7, 10, 0.2334, 53 ); x
```
...
*Sea X una variable aleatoria con distribución uniforme en el conjunto {1,2,3,4,5}. La probabilidad de que el area del rectángulo de lados X y 6-X sea mayor estricto a 8 es de 0.6 ¿Cuantas veces ocurrira esto en 10 experimentos?*
